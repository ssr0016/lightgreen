...
func (app *application) updateMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	// validate the data sending by the client
	v := validator.New()
	...
	// Pass the updated record to new Update() method
	// Intercept any ErrEditConflict error.. avoiding data race
